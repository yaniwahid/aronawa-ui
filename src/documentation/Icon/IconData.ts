export const data = [
  ...
  { name: "shield-slash" },
  { name: "shield" },
  { name: "shopping-basket-bhinneka" },
  { name: "shopping-basket-swoosh-bhinneka" },
  { name: "shopping-bag" },
