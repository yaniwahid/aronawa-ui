...
export default {
  ...
  argTypes: {
    title: {
      ...
      description: 'Use the title prop to change the title of the Drawer',
      table: {
        type: { summary: 'text' },
      },
      control: {
    ...
    isOpen: {
      name: 'isOpen',
      defaultValue: false,
      description: 'Use the isOpen prop to change the isOpen of the Drawer',
      table: {
    ...
    isNoFooter: {
      name: 'isNoFooter',
      defaultValue: false,
      description: 'Use the isNoFooter prop to change the isNoFooter of the Drawer',
      table: {
        type: { summary: 'boolean' },
        defaultValue: { summary: false },
      },
    ...
    isLoading: {
      name: 'isLoading',
      defaultValue: false,
      description: 'Use the isLoading prop to change the isLoading of the Drawer',
      table: {
        type: { summary: 'boolean' },
        defaultValue: { summary: false },
      },
    ...
    isDisabled: {
      name: 'isDisabled',
      defaultValue: false,
      description: 'Use the isDisabled prop to change the isDisabled of the Drawer',
      table: {
        type: { summary: 'boolean' },
        defaultValue: { summary: false },
      },
    ...
    okText: {
      name: 'okText',
      defaultValue: 'Submit',
      description: 'Use the okText prop to change the okText of the Drawer',
      table: {
        type: { summary: 'text' },
    ...
    okColor: {
      ...
      description: 'Use the okColor prop to change the okColor of the Drawer',
      table: {
    ...
    okVariant: {
      name: 'okVariant',
      defaultValue: 'solid',
      description: 'Use the okVariant prop to change the okVariant of the Drawer',
      table: {
    ...
    cancelText: {
      name: 'cancelText',
      defaultValue: 'Cancel',
      description: 'Use the cancelText prop to change the cancelText of the Drawer',
      table: {
        type: { summary: 'text' },
    ...
    cancelColor: {
      name: 'cancelColor',
      defaultValue: 'primary',
      description: 'Use the cancelColor prop to change the cancelColor of the Drawer',
      table: {
        type: { summary: 'neutral | primary | danger' },
        defaultValue: { summary: 'primary' },
      },
    ...
    cancelVariant: {
      name: 'cancelVariant',
      defaultValue: 'ghost',
      description: 'Use the cancelVariant prop to change the cancelVariant of the Drawer',
      table: {
        type: { summary: 'ghost | solid | outline' },
    ...
    size: {
      name: 'size',
      defaultValue: 'md',
      description: 'Use the size prop to change the size of the Drawer',
      table: {
    ...
    isCloseLeft: {
      name: 'isCloseLeft',
      defaultValue: false,
      description: 'Use the isCloseLeft prop to change the isCloseLeft of the Drawer',
      table: {
        type: { summary: 'boolean' },
        defaultValue: { summary: false },
      },
...
export const Basic = (args: IDrawer) => {
...
export const LongContent = (args: IDrawer) => {
  const [{ isOpen }, updateArgs] = useArgs();
  const onClose = () => updateArgs({ isOpen: !isOpen });
  return (
    <>
